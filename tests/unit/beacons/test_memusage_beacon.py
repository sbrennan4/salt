...
STUB_MEMORY_USAGE = namedtuple('vmem', 'total available percent used free active inactive buffers cached shared')(
                               15722012672, 9329594368, 40.7, 5137018880,
                               4678086656, 6991405056, 2078953472,
